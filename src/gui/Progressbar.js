...
export default class ProgressBar extends Gui {
    constructor() {
        super()
        this.maxValue = 0
        this.currentValue = 0
    ...
    applyDecoration() {
        ...
        if (this[`decoration${this.decoration}inside`])
            this.insideContainer.applyStyle(this[`decoration${this.decoration}inside`](this.size.multiply(this.getPixelSize()), this.position.multiply(this.getPixelSize())))
